  ...
  for (;;)
    try {
      if (
        ...
        parseInt(n(437)) / 1 +
          parseInt(n(454)) / 2 +
          (parseInt(n(284)) / 3) * (-parseInt(n(198)) / 4) +
          (-parseInt(n(351)) / 5) * (parseInt(n(242)) / 6) +
          (parseInt(n(194)) / 7) * (parseInt(n(417)) / 8) +
          parseInt(n(231)) / 9 +
          (-parseInt(n(422)) / 10) * (parseInt(n(383)) / 11)
      )
        break;
      a.push(a.shift());
    } catch (e) {
...
const scene = new _0x386f71.Scene();
scene[_0x5826d4(307)] = new _0x386f71.FogExp2(0, 0.0015);
const camera = new _0x386f71[_0x5826d4(176)](
  75,
  window.innerWidth / window[_0x5826d4(174)],
  0.1,
  1e5,
);
...
(centralGlow.scale[_0x5826d4(281)](8, 8, 1),
  scene[_0x5826d4(472)](centralGlow));
for (let e = 0; e < 15; e++) {
...
function getHeartImagesFromURL() {
  ...
  console.log(
    "Không có URL, sử dụng ảnh default:",
    ...
    return new Promise((resolve) => {
      ...
      img.onload = () => {
        ...
        updateLoadingProgress(
          progress,
          `Đã tải hình ${index + 1}/${heartImages.length}`,
        );
        resolve();
      };
      img.onerror = () => {
...
function handleAudioError() {
  ...
  console.log(
    `❌ Không thể tải: ${musicPlaylist[currentMusicIndex]} (Lỗi: ${errorMsg})`,
  );
...
for (let e = 0; e < numGroups; e++) {
  ...
  ((x.crossOrigin = _0x5826d4(236)),
    ...
    (x.onload = () => {
      ...
      heartPointClouds.push(o);
      (o[e(397)].set(d, l, c),
        (o.userData.imageCenter = new _0x386f71.Vector3(d, l, c)),
        (o[e(279)][e(269)] = n),
        (o[e(279)][e(280)] = r),
        (o[e(279)][e(180)] = a),
        (o[e(279)][e(391)] = i),
...
function createHeartBurst(position) {
  ...
  for (let i = 0; i < heartCount; i++) {
    ...
    const texture = new _0x386f71.CanvasTexture(canvas);

    const material = new _0x386f71.SpriteMaterial({
      map: texture,
      transparent: true,
      depthWrite: false,
    ...
    heart.userData.life = 80;
    heart.userData.isBurstHeart = true;
...
function updateBurstHearts() {
  for (let i = burstHearts.length - 1; i >= 0; i--) {
    const heart = burstHearts[i];

    // hiệu ứng nhỏ/lớn tại hình được click
    if (heart.userData.isClickPulse) {
      heart.userData.life--;
      ...
      if (heart.material) {
        heart.material.opacity = heart.userData.life / 25;
      }
    ...
    heart.userData.velocity.multiplyScalar(0.92);
    heart.userData.life--;

    const progress = 1 - heart.userData.life / 40;
    const scaleValue = 0.18 + Math.sin(progress * Math.PI) * 0.12;

    heart.scale.set(scaleValue, scaleValue, 1);

    if (heart.material && heart.material.opacity !== undefined) {
      heart.material.opacity = heart.userData.life / 40;
    }
        ...
        heart.traverse((child) => {
          if (child.isMesh) {
            child.material = new _0x386f71.MeshMatcapMaterial({
              matcap: new _0x386f71.TextureLoader().load(
...
console.log(
  "Chỉ tạo 4 trái tim xung quanh tinh cầu, không tạo trái tim giữa ảnh",
);
...
function createCircleStarTexture(size = 64) {
  const canvas = document.createElement("canvas");
  canvas.width = size;
  canvas.height = size;
...
const starMaterial = new _0x386f71.PointsMaterial({
  color: 0xffffff,
  size: 0.7,
  map: starTexture,
  transparent: true,
...
const starField = new _0x386f71[_0x5826d4(420)](starGeometry, starMaterial);
...
(planet[_0x5826d4(397)][_0x5826d4(281)](0, 0, 0),
  scene[_0x5826d4(472)](planet));
...
function animateHintIcon(t) {
  ...
  if (hintIcon)
    if (introStarted)
      (hintIcon && (hintIcon[n(421)] = !1),
        hintText && (hintText.visible = !1));
    else {
      hintIcon[n(421)] = !0;
      const i = 2.5,
        o = 1.5,
        h = Math[n(310)](t * i) * o,
        e = new _0x386f71[n(459)]();
      (hintIcon.getWorldDirection(e),
        hintIcon.position.copy(hintIcon[n(279)][n(227)])[n(177)](e, -h));
      const c = hintIcon.userData[n(400)],
        a = 1 + 0.1 * Math[n(310)](t * i);
      (c[n(349)][n(281)](a, a, 1),
        (c[n(275)].opacity = 0.5 + 0.2 * Math.sin(t * i)),
        hintText &&
          ((hintText[n(421)] = !0),
          (hintText.material[n(288)] = 0.7 + 0.3 * Math[n(310)](3 * t)),
          (hintText[n(397)].y = 15 + 0.5 * Math[n(310)](2 * t)),
          hintText[n(343)](camera.position)));
    }
}
function updateImagePulse() {
  heartPointClouds.forEach((imageObject) => {
    if (!imageObject.userData.isPulsing) return;

    imageObject.userData.pulseTime += 0.08;

    const t = imageObject.userData.pulseTime;
    const scaleValue = 1 + Math.sin(t * Math.PI) * 0.18;

    imageObject.scale.copy(imageObject.userData.originalScale);
    imageObject.scale.multiplyScalar(scaleValue);

    if (t >= 1) {
      imageObject.scale.copy(imageObject.userData.originalScale);
      imageObject.userData.isPulsing = false;
    }
  });
}
function animate() {
  ...
  const t = 0.001 * performance[e(402)]();
  (animateHintIcon(t),
    controls[e(428)](),
    (planet[e(275)][e(276)][e(457)][e(184)] = 0.5 * t),
    fadeInProgress &&
      fadeOpacity < 1 &&
      ((fadeOpacity += 0.025), fadeOpacity > 1 && (fadeOpacity = 1)),
    introStarted
      ? scene[e(291)]((t) => {
          const n = e;
          (t[n(279)][n(286)] ||
          (t[n(255)] && t[n(255)][n(279)] && t[n(255)].userData[n(286)]) ||
          t === planet ||
          t === centralGlow ||
          "Scene" === t.type
            ? t[n(275)] &&
              void 0 !== t[n(275)].opacity &&
              ((t.material.opacity = 1), (t[n(275)][n(209)] = !1))
            : t[n(275)] &&
              void 0 !== t[n(275)][n(288)] &&
              ((t[n(275)][n(209)] = !0), (t[n(275)][n(288)] = fadeOpacity)),
            t[n(275)] &&
              t.material[n(295)] &&
              t.material[n(295)][n(281)](16777215));
        })
      : ((fadeOpacity = 0.1),
        scene[e(291)]((t) => {
          const n = e;
          t[n(241)] !== n(425)
            ? t.userData[n(286)] ||
              (t.parent && t[n(255)][n(279)] && t[n(255)][n(279)][n(286)])
              ? (t[n(275)] &&
                  void 0 !== t[n(275)][n(288)] &&
                  ((t.material[n(209)] = !1), (t[n(275)].opacity = 1)),
                t[n(275)] &&
                  t.material[n(295)] &&
                  t[n(275)].color[n(281)](16777215))
              : t !== planet &&
                t !== centralGlow &&
                t !== hintIcon &&
                "Scene" !== t.type &&
                ...
                t[n(275)] &&
                void 0 !== t[n(275)].opacity &&
                ((t.material[n(209)] = !0), (t[n(275)][n(288)] = 0.1))
            : t.points &&
              void 0 !== t[n(275)].opacity &&
              ((t[n(275)][n(209)] = !1), (t[n(275)][n(288)] = 1));
        }),
        (planet[e(421)] = !0),
        (centralGlow[e(421)] = !0)));
  for (let n = shootingStars[e(315)] - 1; n >= 0; n--) {
    const a = shootingStars[n];
    a[e(279)][e(287)]++;
    let o = 1;
    if (
      (a.userData.life < 30
        ? (o = a[e(279)][e(287)] / 30)
        : a.userData.life > a.userData[e(412)] - 30 &&
          (o = (a[e(279)].maxLife - a[e(279)].life) / 30),
      (a[e(279)][e(368)] += a[e(279)][e(448)]),
      a[e(279)][e(368)] > 1)
    ) {
      (scene.remove(a), shootingStars[e(452)](n, 1));
      continue;
    }
    const r = a.userData[e(407)].getPoint(a[e(279)][e(368)]);
    (a[e(397)].copy(r),
      (a[e(279)].head[e(275)][e(288)] = o),
      (a[e(279)][e(414)][e(264)][0][e(275)].uniforms.time.value = t));
    const i = a[e(279)][e(170)],
      s = a[e(279)][e(350)];
    s[0][e(462)](r);
    for (let t = 1; t < a[e(279)].trailLength; t++) {
      const n = Math.max(0, a[e(279)].progress - 0.01 * t);
      s[t].copy(a[e(279)].curve[e(468)](n));
    }
    (i.geometry[e(380)](s), (i.material[e(288)] = 0.7 * o));
  }
  (shootingStars[e(315)] < 3 && Math.random() < 0.02 && createShootingStar(),
    scene[e(291)]((t) => {
      const n = e;
      if (t[n(399)] && t.userData[n(269)] && t.userData[n(180)]) {
        const e = t[n(466)].getAttribute("position");
        let a = !1;
        for (let o = 0; o < e[n(202)]; o++) {
          const r = e[n(355)](o) + t[n(397)].x,
            i = e[n(469)](o) + t[n(397)].y,
            s = e[n(341)](o) + t.position.z;
          if (camera[n(397)][n(443)](new _0x386f71.Vector3(r, i, s)) < 10) {
            a = !0;
            break;
          }
        }
        a
          ? t.material !== t[n(279)][n(269)] &&
            ((t[n(275)] = t[n(279)][n(269)]), (t[n(466)] = t[n(279)][n(280)]))
          : t[n(275)] !== t.userData[n(180)] &&
            ((t[n(275)] = t.userData[n(180)]),
            (t.geometry = t[n(279)][n(391)]));
      }
    }),
    planet.lookAt(camera[e(397)]),
    animatePlanetSystem(),
    updateBurstHearts(),
    updateImagePulse(),
    starField &&
      starField[e(275)] &&
      void 0 !== starField[e(275)][e(288)] &&
      ((starField[e(275)][e(288)] = 1), (starField[e(275)][e(209)] = !1)),
...
function createHintText() {
  ...
  const a = n.getContext("2d"),
    o = e(265);
  ((a[e(283)] = e(451) + 50 + e(332)),
    (a[e(185)] = e(356)),
    (a.textBaseline = "middle"),
    (a[e(175)] = e(365)),
    (a[e(458)] = 5),
    (a.lineWidth = 2),
    (a[e(386)] = "rgba(255,111,164,0.8)"),
    a[e(183)](o, 256, 256),
    (a[e(175)] = e(403)),
    (a[e(458)] = 5),
    (a.lineWidth = 2),
    ...
    (a[e(394)] = e(219)),
    a[e(246)](o, 256, 256));
  const r = new _0x386f71.CanvasTexture(n);
  r[e(404)] = !0;
  const i = new _0x386f71[e(439)]({
      map: r,
      transparent: !0,
      side: _0x386f71[e(327)],
    }),
    s = new _0x386f71[e(450)](16, 8);
  ((hintText = new _0x386f71[e(324)](s, i)),
    hintText[e(397)][e(281)](0, 15, 0),
    scene.add(hintText));
}
function startCameraAnimation() {
  const e = _0x5826d4,
    t = { x: camera[e(397)].x, y: camera[e(397)].y, z: camera[e(397)].z },
    n = t.x,
    a = 0,
    o = t.z,
    r = t.x,
  ...
  ((controls[e(409)] = !1),
    (function u() {
      ...
      if (((_ += 0.00101), _ < x)) {
        ...
        let e = (_ - x) / m;
        f = { x: n + (r - n) * e, y: a + (i - a) * e, z: o + (s - o) * e };
      } else {
        if (!(_ < 1.15))
          return (
            camera.position[p(281)](d, l, c),
            camera[p(343)](0, 0, 0),
            controls[p(186)].set(0, 0, 0),
            controls[p(428)](),
            void (controls.enabled = !0)
          );
        {
          let e = (_ - x - m) / 0.4,
            t = 0.5 - 0.5 * Math[p(334)](Math.PI * e);
          f = { x: r + (d - r) * t, y: i + (l - i) * t, z: s + (c - s) * t };
        }
      }
      (camera[p(397)].set(f.x, f.y, f.z),
        camera[p(343)](0, 0, 0),
...
(createShootingStar(),
  createHintIcon(),
  createHintText(),
  window[_0x5826d4(309)](_0x5826d4(321), () => {
    const e = _0x5826d4;
    ((camera[e(259)] = window.innerWidth / window[e(174)]),
      camera[e(426)](),
      renderer[e(303)](window[e(415)], window.innerHeight),
      controls[e(186)][e(281)](0, 0, 0),
      controls[e(428)]());
  }));
...
function requestFullScreen() {
  ...
  t[e(364)]
    ...
    : t[e(467)]
      ...
      : t[e(385)]
        ? t[e(385)]()
        : t[e(375)] && t.msRequestFullscreen();
}
function playImagePulse(imageObject) {
  if (!imageObject || imageObject.userData.isPulsing) return;

  imageObject.userData.isPulsing = true;
  imageObject.userData.pulseTime = 0;
  imageObject.userData.originalScale = imageObject.scale.clone();
}
function createClickPulse(position) {
...
function onCanvasClick(e) {
  ...
  const n = renderer.domElement[t(211)]();
  mouse.x = ((e[t(230)] - n[t(346)]) / n.width) * 2 - 1;
  mouse.y = (-(e[t(216)] - n.top) / n[t(268)]) * 2 + 1;
  raycaster[t(199)](mouse, camera);
  ...
  // Chỉ khi chưa intro mới cho click tinh cầu
  if (raycaster[t(323)](planet)[t(315)] > 0) {
    createHeartsAroundPlanet();

    introStarted = true;
    fadeInProgress = true;

    document.body[t(373)][t(472)](t(353));
    startCameraAnimation();

    starField &&
      starField[t(466)] &&
      starField[t(466)].setDrawRange(0, originalStarCount);
  }
}
function setFullScreen() {
  const e = _0x5826d4,
    t = 0.01 * window[e(174)];
  document[e(204)][e(207)][e(405)](e(181), t + "px");
  const n = document.getElementById(e(240));
  n && (n[e(207)].height = window[e(174)] + "px");
}
(starField &&
  starField.geometry &&
  starField[_0x5826d4(466)][_0x5826d4(178)](
    0,
    Math[_0x5826d4(410)](0.1 * originalStarCount),
  ),
  renderer.domElement[_0x5826d4(309)](_0x5826d4(427), onCanvasClick),
  animate(),
  (planet[_0x5826d4(241)] = "main-planet"),
  (centralGlow[_0x5826d4(241)] = _0x5826d4(313)),
  window.addEventListener(_0x5826d4(321), setFullScreen),
  window[_0x5826d4(309)](_0x5826d4(473), () => {
    setTimeout(setFullScreen, 300);
  }),
  setFullScreen());
const preventDefault = (e) => e[_0x5826d4(314)]();
(document[_0x5826d4(309)](_0x5826d4(200), preventDefault, { passive: !1 }),
  document.addEventListener(_0x5826d4(252), preventDefault, { passive: !1 }));
const container = document[_0x5826d4(290)](_0x5826d4(240));
function checkOrientation() {
  const e = _0x5826d4;
  window[e(174)] > window[e(415)] && e(267) in window
    ? document.body[e(373)][e(472)]("portrait-mode")
    : document[e(297)].classList.remove("portrait-mode");
}
